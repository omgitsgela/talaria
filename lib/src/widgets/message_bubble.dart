...
class _MessageBubbleState extends State<MessageBubble> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_body == null ||
      ...
      _builtTheme = theme;
      _builtMarkdown = markdown;
      MessageBubble.testBuildCounts.update(
          msg.testMessageId, (v) => v + 1, ifAbsent: () => 1);
    }
    return _body!;
  }
  ...
  Widget _buildRow(ThemeData theme, bool markdown) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...children,
          if (!isUser && message.pending && message.text.isEmpty &&
              message.tools.isEmpty && message.reasoning.isEmpty)
